...
<span style="color: red; font-weight: bold;">あなたが書いた記事が、DENXの評判を左右します。</span>  
誰に見られても恥ずかしくないような、丁寧な言葉遣い・言い回しを心掛けましょう。  
<br>

### 内容に注意！！！
<b>誰が読んでも分かりやすい内容</b>を心掛けて書きましょう。  
もちろん、<span style="color: red; font-weight: bold;">公序良俗に反する内容（R-18な内容、差別的・暴力的発言etc.）、過度な身内ネタは禁止。</span>  
<br>

### 句読点について
ピリオド・カンマは使わず、<b>句読点（。、）で文章を書いてください。</b>  
理系論文でピリオド・カンマを使いたがるのは、<u>英語と同じにしたいから</u>という理由があります。  
が、<u>このサイトにおいては日本語が主体の世界</u>ですので、日本語において最も合理的な句読点を使用してください。  
<br>
